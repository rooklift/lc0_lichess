Simple Lc0 runner for Lichess API - runs Lc0 at a specified number of nodes, ignoring the time control. The config file should be fairly self explanatory. Rename it `config.json` to actually use it.
